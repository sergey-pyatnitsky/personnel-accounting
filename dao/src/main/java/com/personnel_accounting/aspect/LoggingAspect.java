...
public class LoggingAspect {
    private static final Logger logger = LoggerFactory.getLogger("DAO logger");
    ...
    @Pointcut("execution(* *(..)) &&\n" +
            "(\n" +
            "    within(com.personnel_accounting..authority..*) ||\n" +
            "    within(com.personnel_accounting..department..*) ||\n" +
            "    within(com.personnel_accounting..employee..*) ||\n" +
            "    within(com.personnel_accounting..employee_position..*) ||\n" +
            "    within(com.personnel_accounting..position..*) ||\n" +
            "    within(com.personnel_accounting..profile..*) ||\n" +
            "    within(com.personnel_accounting..project..*) ||\n" +
            "    within(com.personnel_accounting..report_card..*) ||\n" +
            "    within(com.personnel_accounting..task..*) ||\n" +
