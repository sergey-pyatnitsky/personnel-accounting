...
@ComponentScan(value = "com.personnel_accounting",
        excludeFilters = {@ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = {ServiceConfiguration.class})})
...
public class ServiceTestConfiguration {
    ...
    public ServiceTestConfiguration(Environment env) {
        this.env = env;
    }
    ...
    public void migrateFlyway() {
        Flyway.configure().locations("classpath:test.db.migration").dataSource(dataSource())
                .cleanOnValidationError(true).baselineOnMigrate(true).load().migrate();
    }
