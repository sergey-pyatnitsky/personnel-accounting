...
public class LoggingAspect {
    private static final Logger logger = LoggerFactory.getLogger("Web logger");
    ...
    @Pointcut("execution(* *(..)) &&\n" +
            "(\n" +
            "    within(com.personnel_accounting..controller.page..*) ||\n" +
            "    within(com.personnel_accounting..controller.rest..*)\n" +
            ")")
