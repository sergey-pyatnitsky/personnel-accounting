...
public class PageController {
    ...
    private String getJwtToken(User user) {
        ...
        ResponseEntity<String> response =
                restTemplate.postForEntity(
                        ...
                        new User(user.getUsername(), emailPassword, user.isActive()),
                        String.class);
    ...
    private User getUserInfo(OAuth2AuthorizedClient client) {
        ...
        if (!userInfoEndpointUri.isEmpty()) {
            ...
            User user = userService.findByUsername((String) userAttributes.get("email"));
            if (user == null)
                userService.registerUser(new User(userEmail, false),
